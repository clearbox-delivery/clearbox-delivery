...
**Note**: See `docs/PHASE3_NOTES.md` for temporary data sources (ETA/distance placeholders, promised time calculation using `created_at` instead of `accepted_at`, MenuManagement mock data and missing backend integration).
